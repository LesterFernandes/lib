...
| `/members/[memberId]` | View member details and borrowing history, borrow books, and record returns. Only members can borrow; each book can have one current loan. |
